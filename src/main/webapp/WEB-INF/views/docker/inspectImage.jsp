...
<%@ include file="/WEB-INF/views/jspf/header.jspf" %>
   ...
   <h3><spring:message code="docker.image.inspect.title"/> <c:out value="${inspectImageResponse.id}" /></h3>
   <p><spring:message code="docker.image.inspect.message"/></p>
   ...
   <c:choose>
    ...
    <table class="list"> 
     <thead>
      <tr>
       <th>
        <spring:message code="docker.image.inspect.attributeName"/>
       </th>
       <th>
        <spring:message code="docker.image.inspect.attributeValue"/> 
       </th>
      </tr>
     </thead>
     <tbody>
